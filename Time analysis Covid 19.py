...
Original file is located at
    https://colab.research.google.com/drive/13QICVY4eH1FoJG2im6a5xWD3FTlNfyhk
...
cord.rename(columns={"State/UT" :"State"},inplace = True)
...
l = [tri.columns.to_list()[2], tri.columns.to_list()[4],tri.columns.to_list()[6]]
fig = go.Figure()
...
tes = pd.read_csv("StatewiseTestingDetails.csv")
